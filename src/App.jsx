...
>
  ...
  <div className="flex flex-wrap justify-center gap-6">
    ...
    <motion.div
      ...
      className="p-6 flex flex-col items-center shadow-lg hover:text-red-800 justify-center hover:shadow-2xl w-[160px] sm:w-[180px] md:w-[200px] h-[160px] rounded-2xl"
    >
      <SiNestjs size={60} />
