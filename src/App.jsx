...
>
  ...
  <div className="flex flex-wrap justify-center gap-6">
    ...
    <motion.div
      ...
      transition={{ duration: 0.5 }}
      className="p-6 flex flex-col items-center shadow-lg md:text-black md:hover:text-[#E34F26] sm:text-[#E34F26] justify-center hover:shadow-2xl w-[160px] sm:w-[180px] md:w-[200px] h-[160px] rounded-2xl"
    >
      <FaHtml5 size={60} />
    ...
    <motion.div
      ...
      className="p-6 flex flex-col items-center shadow-lg md:text-black md:hover:text-[#1572B6] sm:text-[#1572B6] justify-center hover:shadow-2xl w-[160px] sm:w-[180px] md:w-[200px] h-[160px] rounded-2xl"
    >
      <FaCss3Alt size={60} />
    ...
    <motion.div
      ...
      className="p-6 flex flex-col items-center shadow-lg md:text-black hover:text-[#F7DF1E] sm:text-[#F7DF1E] justify-center hover:shadow-2xl w-[160px] sm:w-[180px] md:w-[200px] h-[160px] rounded-2xl"
    >
    ...
    <motion.div
      ...
      className="p-6 flex flex-col items-center shadow-lg md:text-black hover:text-[#3178C6] sm:text-[#3178C6] justify-center hover:shadow-2xl w-[160px] sm:w-[180px] md:w-[200px] h-[160px] rounded-2xl"
    >
    ...
    <motion.div
      ...
      className="p-6 flex flex-col items-center shadow-lg md:text-black md:hover:text-[#61DAFB] sm:text-[#61DAFB] justify-center hover:shadow-2xl w-[160px] sm:w-[180px] md:w-[200px] h-[160px] rounded-2xl"
    >
      <GrReactjs size={60} />
    ...
    <motion.div
      ...
      className="p-6 flex flex-col items-center shadow-lg md:text-black md:hover:text-[#38BDF8] sm:text-[#38BDF8] justify-center hover:shadow-2xl w-[160px] sm:w-[180px] md:w-[200px] h-[160px] rounded-2xl"
    >
    ...
    <motion.div
      ...
      className="p-6 flex flex-col items-center shadow-lg md:text-black md:hover:text-[#E0234E] sm:text-[#E0234E] justify-center hover:shadow-2xl w-[160px] sm:w-[180px] md:w-[200px] h-[160px] rounded-2xl"
    >
      <SiNestjs size={60} />
    ...
    <motion.div
      ...
      className="p-6 flex flex-col items-center shadow-lg md:text-black md:hover:text-[#4169E1] sm:text-[#4169E1] justify-center hover:shadow-2xl w-[160px] sm:w-[180px] md:w-[200px] h-[160px] rounded-2xl"
    >
  ...
  <motion.div className="flex flex-col justify-center items-center gap-10">
    {[
      ...
      >
        ...
        {/* Text */}
        <div className="mt-6 md:mt-0 md:ml-8 flex flex-col w-full md:w-2/3">
